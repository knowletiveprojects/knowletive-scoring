    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .feat:hover { background:rgba(255,255,255,0.055); border-color:rgba(255,255,255,0.1); }
        ...
        .rtab { flex:1; padding:10px; border-radius:9px; border:none; cursor:pointer; font-weight:700; font-size:13px; font-family:'DM Sans',sans-serif; transition:all .2s; }
        ...
        .sbtn {
          ...
          color:#fff; box-shadow:0 6px 22px rgba(13,148,136,0.35);
          transition:all .25s; position:relative; overflow:hidden;
        }
        .sbtn:hover { transform:translateY(-1px); box-shadow:0 10px 28px rgba(13,148,136,0.42); }
        .sbtn:active { transform:translateY(0); }
        .sbtn:disabled { opacity:.55; cursor:not-allowed; transform:none!important; }
        .sbtn-v { background:linear-gradient(135deg,#6366f1,#8b5cf6); box-shadow:0 6px 22px rgba(99,102,241,0.35); }
        .sbtn-v:hover { box-shadow:0 10px 28px rgba(99,102,241,0.42); }
        .shine { position:absolute; top:0; left:-100%; width:50%; height:100%; background:linear-gradient(90deg,transparent,rgba(255,255,255,0.16),transparent); animation:shimmer 2.6s ease-in-out infinite; }
        ...
        @media(max-width:860px){
          ...
          .lp-headline { font-size: clamp(32px,9vw,48px)!important; }
        }
      `}</style>
      ...
      <div className="page">
        ...
        <div className="lp">
          ...
          <div style={{position:"absolute",width:520,height:520,borderRadius:"50%",background:"radial-gradient(circle,rgba(20,184,166,0.12) 0%,transparent 65%)",top:-180,left:-140,filter:"blur(70px)",pointerEvents:"none"}}/>
          <div style={{position:"absolute",width:400,height:400,borderRadius:"50%",background:"radial-gradient(circle,rgba(6,182,212,0.1) 0%,transparent 65%)",bottom:-120,right:-80,filter:"blur(70px)",pointerEvents:"none"}}/>
          ...
          <div className="f1" style={{marginBottom:40, position:"relative", zIndex:2}}>
            <div style={{
              fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:"clamp(24px,2.4vw,32px)",
              letterSpacing:"-1px", lineHeight:1,
              background:"linear-gradient(135deg,#fff 0%,#e0f2fe 50%,#99f6e4 100%)",
              WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", backgroundClip:"text",
            }}>Knowletive</div>
            <div style={{ fontSize:12.5, fontWeight:600, letterSpacing:"1.5px", textTransform:"uppercase", color:"rgba(255,255,255,0.55)", marginTop:6 }}>
          ...
          <div className="f2 lp-headline" style={{ position:"relative", zIndex:2, marginBottom:18 }}>
            <div style={{
              fontFamily:"'Syne',sans-serif", fontSize:"clamp(38px,4.6vw,60px)", fontWeight:800,
          ...
          <p className="f2" style={{ color:"rgba(255,255,255,0.4)", fontSize:15, lineHeight:1.7, maxWidth:440, position:"relative", zIndex:2, marginBottom:36 }}>
          ...
          <div className="f3" style={{ position:"relative", zIndex:2 }}>
            {[
              {icon:"📊", bg:"rgba(20,184,166,0.14)", title:"Daily Score Tracking",  desc:"Attendance, participation, and technical performance"},
              {icon:"🏆", bg:"rgba(245,158,11,0.12)", title:"Live Leaderboard",       desc:"Real-time rankings after every submission"},
              {icon:"📈", bg:"rgba(6,182,212,0.11)",  title:"Progress Analytics",    desc:"Clear growth trends from Beginner to Pro"},
            ].map(f=>(
              <div key={f.title} className="feat">
                <div className="fico" style={{background:f.bg}}>{f.icon}</div>
                <div>
                  <div style={{fontWeight:700,fontSize:14,color:"#fff"}}>{f.title}</div>
                  <div style={{fontSize:12.5,color:"rgba(255,255,255,0.35)",marginTop:2}}>{f.desc}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="rp">
          ...
          <div className="f1" style={{textAlign:"center",marginBottom:24,width:"100%"}}>
            <div style={{display:"flex",justifyContent:"center",marginBottom:14}}>
              <Image src="/logo.png" alt="Knowletive" width={72} height={72} style={{objectFit:"contain"}}/>
            </div>
            <h2 style={{fontFamily:"'Outfit',sans-serif",fontSize:23,fontWeight:800,color:"#0f172a",letterSpacing:"-0.5px",marginBottom:5}}>Welcome back</h2>
            <p style={{color:"#94a3b8",fontSize:13.5}}>Sign in to continue</p>
          </div>
          ...
          <div className="f4" style={{width:"100%",marginTop:32,textAlign:"center"}}>
